...
function FormScreen() {
    ...
    const informationContent = <Form noValidate validated={validated} onSubmit={handleSubmit}>
        {/*First row*/}
        <Row className="mb-3">
            {/*DNI*/}
            <Form.Group as={Col} controlId="formDNI">
                <Form.Label>{strings.formInformationDNI}*</Form.Label>
                <Form.Control required type="text" placeholder={strings.formInformationDNIPlaceHolder}/>
                <Form.Text className="text-muted">
                    {strings.formShareWithAnyoneElse}
                </Form.Text>
            ...
            <Form.Group as={Col} controlId="formFirstName">
                ...
                <Form.Control required type="text" placeholder={strings.formInformationFirstNamePlaceHolder} />
                <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
            ...
            <Form.Group as={Col} controlId="formLastName">
                ...
                <Form.Control required type="text" placeholder={strings.formInformationLastNamePlaceHolder} />
                <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
            ...
            <Col md>
                <FloatingLabel controlId="formGender" label="Gender">
                    <Form.Select aria-label="Floating label select example">
                        ...
                        <option value="2">{strings.formInformationGenderOther}</option>
                    </Form.Select>
                </FloatingLabel>
            </Col>
        </Row>
        ...
        <Row className="mb-3">
            ...
            <Form.Group as={Col} controlId="formCompanyName">
                ...
                <Form.Control required type="text" placeholder={strings.formInformationCompanyNamePlaceHolder} />
                <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
            ...
            <Form.Group as={Col} controlId="formCompanyDirection">
                ...
                <Form.Control required type="text" placeholder={strings.formInformationCompanyDirectionPlaceHolder} />
                <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                <Form.Control.Feedback type="invalid">
            ...
            <Form.Group as={Col} controlId="formFiscalNumber">
                ...
                <Form.Control required type="text" placeholder={strings.formInformationCompanyNumberPlaceHolder} />
                <Form.Text className="text-muted">
                    {strings.formShareWithAnyoneElse}
                </Form.Text>
                <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                ...
                <TabsFormScreen tabs={[
                    ...
                    },
                    {
                        ...
                        content: <Form noValidate validated={validated} onSubmit={handleSubmit}>
                            {/*First row*/}
                            <>
                                <Form.Label>{strings.formSLASpecificationDuration}</Form.Label>
                            ...
                            {/*Third row*/}
                            <Row className="mb-3">
                                <Form.Label>{strings.formSLASpecificationClientContact}</Form.Label>
                                {/*FirstName*/}
                                <Form.Group as={Col} controlId="formContactFirstName">
                                    <Form.Label>{strings.formSLASpecificationContactFirstName}*</Form.Label>
                                    <Form.Control required type="text" placeholder={strings.formSLASpecificationContactFirstNamePlaceHolder} />
                                    <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                                    <Form.Control.Feedback type="invalid">
                                        {strings.formSLASpecificationContactFirstNameError}
                                    </Form.Control.Feedback>
                                </Form.Group>
                                {/*LastName*/}
                                <Form.Group as={Col} controlId="formContactLastName">
                                    <Form.Label>{strings.formSLASpecificationContactLastName}*</Form.Label>
                                    <Form.Control required type="text" placeholder={strings.formSLASpecificationContactLastNamePlaceHolder} />
                                    <Form.Control.Feedback>{strings.formLooksGood}</Form.Control.Feedback>
                                    <Form.Control.Feedback type="invalid">
                                        {strings.formSLASpecificationContactLastNameError}
                                    </Form.Control.Feedback>
                                </Form.Group>
                            </Row>
                            <Row className="mb-3">
                                <Form.Group as={Col} controlId="formContactEmail">
                                    ...
                                    <Form.Control type="email" placeholder={strings.formSLASpecificationContactEmailPlaceHolder} />
                                </Form.Group>
                                <Form.Group as={Col} controlId="formContactPhone">
                                    <Form.Label>{strings.formSLASpecificationContactPhone}</Form.Label>
                                    <Form.Control type="text" placeholder={strings.formSLASpecificationContactPhonePlaceHolder} />
                                </Form.Group>
                            </Row>
                            {/*Fourth row*/}
                            <Row className="mb-3">
                                <Form.Label>{strings.formSLASpecificationServiceProviderContact}</Form.Label>
                                {/*FirstName*/}
                                <Form.Group as={Col} controlId="formContactFirstName">
                                    <Form.Label>{strings.formSLASpecificationContactFirstName}*</Form.Label>
                                    <Form.Control required type="text" placeholder={strings.formSLASpecificationContactFirstNamePlaceHolder} />
                            ...
                            <Form.Group className="mb-3" controlId="formServiceExclusion">
                                <Form.Label>{strings.formSLASpecificationServiceExclusions}</Form.Label>
                                <Form.Control as="textarea" rows={3} />
                            </Form.Group>
                    ...
                    {
                        title: strings.formServiceAssurance,
                        content: <Form noValidate validated={validated} onSubmit={handleSubmit}>
                            {/*First row*/}
                            <Form.Group className="mb-3" controlId="formComplaintProcedure">
                                <Form.Label>{strings.formServiceAssuranceComplaintProcedure}</Form.Label>
                                <Form.Control as="textarea" rows={3} />
                            </Form.Group>
                            {/*Second row*/}
                            <Form.Group className="mb-3" controlId="formPerformancePenalty">
                                <Form.Label>{strings.formServiceAssurancePerformPenalty}</Form.Label>
                                <Form.Control as="textarea" rows={3} />
                            </Form.Group>
                            {/*Third row*/}
                            <Form.Group className="mb-3" controlId="formOperatingSafety">
                                <Form.Label>{strings.formServiceAssuranceOperatingSafety}</Form.Label>
                                <Form.Control as="textarea" rows={3} />
                            </Form.Group>
                            {/*Fourth row*/}
                            ...
                            <Form.Floating className="mt-3 mb-3">
                                ...
                                />
                                <label htmlFor="floatingInputCustom">{strings.formServiceAssuranceRecipientEmail}</label>
                            </Form.Floating>
                            {/*Fifth row*/}
                            <Form.Group className="mb-3" controlId="formIncidentManagement">
                                <Form.Label>{strings.formServiceAssuranceIncidentManager}</Form.Label>
                                <Form.Control as="textarea" rows={3} />
                            </Form.Group>
                            {/*Sixth row*/}
                            <Form.Group className="mb-3" controlId="formConfidentiality">
                                <Form.Label>{strings.formServiceAssuranceConfidentiality}</Form.Label>
                                <Form.Control as="textarea" rows={3} />
                            </Form.Group>
                            {/*Seventh row*/}
                            <Form.Label>{strings.formServiceAssuranceServiceMonitoring}</Form.Label>
                            <Row className="g-2">
                                {/*Service Monitoring*/}
                                <Col md>
                                    <FloatingLabel controlId="formMonitoring" label="Monitoring Period">
                                        <Form.Select>
                                            <option>{strings.formServiceAssuranceSelectServiceMonitoring}</option>
                            ...
                            {/*Eighth row*/}
                            <Form.Label>{strings.formServiceAssuranceServiceBilling}</Form.Label>
                            <Row className="g-2">
                                {/*Service Billing*/}
                                <Col md>
